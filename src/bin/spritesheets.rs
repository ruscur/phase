...
fn main() {
    ...
    let dots: Vec<Rect> = vec!(Rect::new(0, 0, 100, 100),
                            Rect::new(100, 0, 100, 100),
                            Rect::new(0, 100, 100, 100),
                            Rect::new(100, 100, 100, 100));

    let dests: Vec<Rect> = vec!(Rect::new(0, 0, 100, 100),
                            Rect::new((SCREEN_WIDTH - 100) as i32, 0, 100, 100),
                            Rect::new(0, (SCREEN_HEIGHT - 100) as i32,
                                100, 100),
                            Rect::new((SCREEN_WIDTH - 100) as i32,
                                (SCREEN_HEIGHT - 100) as i32, 100, 100));
